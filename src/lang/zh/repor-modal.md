...
除非你的 bug 只有在构建工具下才能重现，否则我们建议使用诸如 [ui-nuclear](https://gitlab.oneitfarm.com/ladybird/ui-nuclear), [iview](https://www.iviewui.com/) 或是 [Codepen](https://codepen.io) 这样的在线代码服务来提供重现。如果你的 bug 必须用到构建工具，那么我们建议使用 [vue-cli](https://github.com/vuejs/vue-cli) 来搭建一个新项目，推送到 GitHub 并提供仓库的链接。
